function Get-CippTestDataFieldManifest {
    ...
    if (-not $script:CippTestDataFieldManifest) {
        ...
        $script:CippTestDataFieldManifest = @{
            ...
            'ExoHostedContentFilterPolicy'       = @('Name', 'Identity', 'AllowedSenders', 'AllowedSenderDomains', 'EnableSafeList', 'SpamAction', 'SpamQuarantineTag', 'HighConfidenceSpamAction', 'HighConfidenceSpamQuarantineTag', 'BulkSpamAction', 'BulkQuarantineTag', 'PhishSpamAction', 'HighConfidencePhishAction', 'RecipientDomainIs', 'BulkThreshold', 'MarkAsSpamBulkMail', 'QuarantineRetentionPeriod', 'InlineSafetyTipsEnabled', 'IPAllowList', 'PhishZapEnabled', 'SpamZapEnabled', 'RecommendedPolicyType',
